...
GLOBAL_OPCODE_MAP = {
    ...
    0x2D : ['sub , ', False, 'id', None ],
    0x29 : ['sub ', True, 'mr', None],
    0x2B : ['sub ', True, 'rm', None ],
    0xA9 : ['test , ', False, 'id', None], 
    0x85 : ['test ', True, 'mr', None ],
    0x35 : ['xor , ', False, 'id', None],
